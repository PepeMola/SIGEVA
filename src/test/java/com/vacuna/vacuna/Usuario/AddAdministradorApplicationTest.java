...
class AddAdministradorApplicationTest {
	@Autowired
	...
	private String TEST_EMAIL = "pruebaAdministrador1@gmail.com";
	...
	private String TEST_CENTROASIGNADO = "Centro Prueba add Admin";
	 ...
	 * @throws Exception
	 */
	void saveAdministradorCorrecto() throws Exception {
	 ...
	 * @throws Exception
	 */
	void expectedErrorAdministradorExistente() throws Exception {
		JSONObject json = new JSONObject();
		json.put("nombre", TEST_NOMBRE);
		json.put("email", TEST_EMAIL);
		json.put("password", TEST_PASSWORD);
